                ...
                while (!reader.EndOfStream)
                {
                  ...
                  //  quiz[1] = quiz2;
                   ...
                   // quiz[3] = quiz4;
                    ...
                    student.final =values[8]== "" ? "0" : values[7];
                    student.viva= values[9] == "" ? "0" : values[7];
                   Array.Sort(quiz);
                    student.percentage = (Convert.ToInt32(student.attendance) + Convert.ToInt32(student.quizes[1]) +Convert.ToInt32( student.quizes[2] )+ Convert.ToInt32(student.quizes[3]) + Convert.ToInt32(student.mid) + Convert.ToInt32(student.final) + Convert.ToInt32(student.viva))/3;
